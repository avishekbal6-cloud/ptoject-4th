...
router.get('/professional/bookings', authenticate, authorize('professional'), async (req: AuthRequest, res: Response) => {
  try {
...
router.put('/:id/status', authenticate, authorize('professional'), async (req: AuthRequest, res: Response) => {
  try {
